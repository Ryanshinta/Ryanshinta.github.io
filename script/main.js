...
//     appkey: 'BC-5e07a13038db4206bbf0a14841f32ec0', // GoEasy应用appkey，替换成你的appkey
    ...
    chatRoom: null,
    appId: '6fnCcQ1fKEiLfmpdOmKhucm4-MdYXbMMI',
    appKey: 'MoAKF4a4XlBBiPrgz3Ixru3p',
    server: 'https://6fnccq1f.api.lncldglobal.com', // REST API 服务器地址
  },
  methods: {
    randomString(length) {
      let str = ''
...
//     })
    ...
    var roomId = this.getParam("id")?this.getParam("id"):'641d31d3cb19404db98786b4'
